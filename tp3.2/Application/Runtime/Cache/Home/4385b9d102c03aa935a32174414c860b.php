...
<head>
    ...
    <title>微留言演示案例</title>
    <link rel="stylesheet" type="text/css" href="/tp3.2/Public/message./msg.css" media="all" />	
</head>
<body id="message" onselectstart="return true;" ondragstart="return false;">
	<div class="container">
	  	<div class="qiandaobanner">
		  	<a href="/tp3.2/Public/message">
		  		<img src="/tp3.2/Public/message/wall.jpg" style="width:100%;" />
		  	</a>
	  	</div>
				...
				<div class="history-date">
					<ul>
						...
						<?php if(is_array($msgs)): foreach($msgs as $key=>$msg): ?><li class="green bounceInDown">
							<h3>
								<img src="/tp3.2/Public/message/logo100x100.jpg"> 
								<?php echo ($msg["uname"]); ?><span><?php echo date('Y-m-d h:m:s',$msg['created_at']);?></span>
								<div class="clr"></div>
							</h3>
							<dl>
						...
						<li class="green bounceInDown nob ly2" style="display:none;">
							<form action="<?php echo U('home/msg/add');?>" method="post" class="form1">
							<dl>
								<dt>
	...
	<script type="text/javascript" src="/tp3.2/Public/message/jquery.js"></script>
